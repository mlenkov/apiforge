...
class Client:
    ...
    def __init__(
        ...
        Args:
            ...
            on_before_request: Hook called before each request (method, url) -> None.
                Useful for MCP access control, audit logging, token refresh.
        """
        if config_path:
